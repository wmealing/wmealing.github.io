...
Listed below is an example of a process sending a message to another process using the method described above.

// TODO: Should i go into details on selecting a message here, or cut the demonstration down a little more ?
