...
* Simple WX examle in erlang [July 2022]
  ...
  I don't always write a gui for my apps, but when I do, I use wx
  becaue I'm not one for complaining about pixel perfect pedantry.

  I do it something that works, at the moment thats [[file:wx-erlang-example.org][WX-ERLANG]].
