#+TITLE: CELLIUM 003: progress_bar 
#+DATE: [2025-10-28 Tue] 
#+AUTHOR: W. Mealing 
...
#+BEGIN_SRC erlang
  build_bar(Percentage) -> Filled = calculate_filled(Percentage), Empty = 20 - Filled, FilledChars = lists:duplicate(Filled, 9608), EmptyChars = lists:duplicate(Empty, 9617), AllChars = FilledChars ++ EmptyChars, unicode:characters_to_binary(AllChars). 
#+END_SRC
