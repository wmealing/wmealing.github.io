...
In the company I work at, these improved error helpers  are called "Wilbert-Hofman" error messages.
...
These  "Wilbert-Hofman" error messages are used heavily in the group of the company where I work.
